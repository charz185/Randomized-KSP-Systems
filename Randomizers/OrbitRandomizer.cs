...
namespace RandomizedSystems.Randomizers
{
    ...
    public class OrbitRandomizer : PlanetRandomizer
    {
        ...
        public override void Cache()
        {
            ...
            {
                referenceBody = solarSystem.sunData.planet;
        ...
        {
            if (orbitData.randomized || WarpDrivers.WarpDrive.seedString == "1")
            {
            ...
            {
                // Special case
                orbitData.referenceBody = solarSystem.sunData.planet;
        ...
        private void CreateReferenceBody(bool forcePlanet = false)
        {
            ...
            else
            {
                ...
                while ((referenceBody == null || referenceBody == planet || referenceBodyData.referenceBody != solarSystem.sunData.planet || referenceBody.Radius < planet.Radius))
                {
                    attempts++;
        ...
        private double CreateMoon()
        {
            ...
            double parentAtmosphereHeight = planet.Radius + (sphereOfInfluence * 0.5) + referenceBody.Radius + (referenceBody.atmosphereDepth * 1000.0 * Mathf.Log(1000000.0f));
                                   ...
                                   CelestialBody referenceBody)
        {
            ...
            {
                semiMajorAxis = referenceBody.Radius + referenceBody.atmosphereDepth + 10000;
